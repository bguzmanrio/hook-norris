...
const useRequest = () => {
  ...
  return [saying, sayingTime, loading, tooMuchDelay, handleClick];
};

const HookNorris = () => {
  const [saying, sayingTime, loading, tooMuchDelay, handleClick] = useRequest();
  
  return (
    <Wrapper>
      <HookNorrisSays saying={saying} extra="Custom hooks" />
